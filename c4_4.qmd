...
backward_model <- step(
  lm(medv ~ crim + rm + tax + age + dis, data = Boston),
  direction = "backward"
)
summary(backward_model)
...
- [data programming with R](https://datageneration.io/dataprogammingwithr/intro)
- Chicago Harris School Coding Camp
- [The U.S. government's open data portal](https://data.gov/)
- [MASS Package](https://cran.r-project.org/web/packages/MASS/MASS.pdf)
- [Tidyverse Diamonds](https://ggplot2.tidyverse.org/reference/diamonds.html)
- [Wage: Mid-Atlantic Wage Data](https://rdrr.io/cran/ISLR/man/Wage.html)
