...
3) Interpret the p-value to determine if the difference in mean prices is statistically significant. <br>
...
### Reference
- [data programming with R](https://datageneration.io/dataprogrammingwithr/intro)
